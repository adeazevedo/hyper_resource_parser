...
urlpatterns = (
    ...
    url(r'^edificacoes-de-construcao-aeroportuaria/(?P<id_objeto>[0-9]*)/?$', views.EdifConstPortuariaDetail.as_view(), name='edif_const_portuaria_detail_id_objeto'),
    url(r'^edificacoes-de-construcao-aeroportuaria/(?P<id_objeto>[0-9]*)/(?P<attributes_functions>.*)/?$', views.EdifConstPortuariaDetail.as_view(), name='edif_const_portuaria_detail_af'),
